                ...
                <div v-show="currentActive === 0">
                    ...
                    <div class="config-item special-item">
                        ...
                        <el-slider 
                            ...
                            show-input
                            @change="leftMainChange"></el-slider>
                    </div>
                    <div class="config-item special-item">
                        ...
                        <el-slider 
                            ...
                            show-input
                            @change="leftSubChange"></el-slider>
                    </div>
                    <div class="config-item">
                ...
                <div v-show="currentActive === 1">
                    ...
                    <div class="config-item special-item">
                        ...
                        <el-slider 
                            ...
                            show-input
                            @change="rightMainChange"></el-slider>
                    </div>
                    <div class="config-item special-item">
                        <div class="title">{{$t('pcdecorate.storeList.subTitleSize')}}</div>
                        <el-slider 
                            ...
                            show-input
                            @change="rightSubChange"></el-slider>
                    </div>
                    <div class="config-item">
                        <div class="title">{{$t('pcdecorate.goodsList.addgoods')}}({{$t('shopFeature.goodsModule.maxAdd')}}2{{$t('shopProcess.piece')}})</div>
                        <div class="bottom-config">
  ...
  methods: {
    ...
    leftSubChange (val) {
      return this.formData.leftConfig.subTitleSize = Math.floor(val)
        ...
        // 右标题
    rightMainChange (val) {
      return this.formData.rightConfig.mainTitleSize = Math.floor(val)
    },
        // 右副标题
    rightSubChange (val) {
      return this.formData.rightConfig.subTitleSize = Math.floor(val)
    }
  }
}
</script>
