    ...
    <div class="prods-select-body">
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <div class="prod-info">
              <img v-if="scope.row.pic" :src="scope.row.pic.indexOf('http')===-1 && scope.row.pic.indexOf('https')=== -1 ? resourcesUrl + scope.row.pic : scope.row.pic" width="48" height="48">
            ...
            prods.push(
              {
                ...
                pic: flag ? this.resourcesUrl + item.pic : item.pic,
