            ...
            <el-form :inline="true" class="search-form" ref="searchForm" :model="searchForm" size="small">
                <div class="input-row">
                    ...
                    <el-form-item label="编号" class="search-form-item">
                        <el-input type="text" v-model="searchForm.cardNumber" placeholder="请输入编号"></el-input>
                    </el-form-item>
...
export default {
    ...
    methods: {
      ...
      getDataList (page, newData = false) {
        ...
        this.searchForm.startTime = this.launchDateRange === null ? null : this.launchDateRange[0]
        this.searchForm.endTime = this.launchDateRange === null ? null : this.launchDateRange[1]
