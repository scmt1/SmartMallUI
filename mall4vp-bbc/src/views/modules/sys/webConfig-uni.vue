<template>
  <div class="mod-webConfig-webConfig">
    <div class="main-container">
      ...
      <!-- 表格 -->
      <div class="table-con webConfig-uni-table">
        <el-table
          ref="webConfigUniTable"
          :data="dataList"
          ...
          >
            <template slot-scope="scope">
              <div class="table-cell-image">
                <img v-if="scope.row.uniLoginLogoImg" :src="scope.row.uniLoginLogoImg" />
              </div>
            </template>
          </el-table-column>
          <!-- 激活状态 -->
...
export default {
  data () {
    return {
      ...
      configType: 3 // 配置类型（1:后台 2:PC端 3:h5端）
    }
  },
  components: {
    AddOrUpdate
