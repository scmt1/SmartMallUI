  ...
  <div class="mod-role">
    ...
    <div class="search-bar">
      <el-form :inline="true" class="search-form" ref="searchForm" :model="searchForm" size="small">
        <div class="input-row">
          <el-form-item :label="$t('sys.roleName') + ':'" class="search-form-item">
            <el-input type="text" v-model="searchForm.roleName" :placeholder="$t('sys.roleName')"></el-input>
          </el-form-item>
          <el-form-item>
    ...
    <div class="main-container">
      ...
      <div class="operation-bar">
        <el-checkbox v-model="selectAll" :disabled="!dataList.length" @change="handleSelectAll" v-if="dataList.length" class="all-check-btn">{{$t('publics.selectAll')}}</el-checkbox>
...
export default {
  ...
  methods: {
     ...
     */
    handleSelectAll () {
      if (this.$refs.sysRoleTable.selection.length < this.dataList.length) {
        this.selectAll = true
      } else {
        this.selectAll = false
      }
      this.$refs.sysRoleTable.toggleAllSelection()
    },
    // 新增 / 修改
