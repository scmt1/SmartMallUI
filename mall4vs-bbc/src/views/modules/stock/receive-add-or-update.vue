  ...
  <div class="container">
    <div class="content-container">
      <div class="new-page-title">
        <div class="line" />
        <div class="text">
          {{this.$i18n.t('stock.newWarehousingDetails')}}
        </div>
      </div>
      <basicInfo :type="dataForm.type" :stockBillLogId="parseInt(stockBillLogId)" ref="basicInfo"></basicInfo>
      <skuListInfo :type="dataForm.type" :stockBillLogId="parseInt(stockBillLogId)" ref="skuListInfo"></skuListInfo>
    </div>
    <div class="foot-btn">
      <div class="default-btn primary-btn" @click="confirmSave(1)">{{this.$i18n.t('stock.confirmWarehousing')}}</div>
