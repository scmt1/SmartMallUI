<template>
  <div class="billing-box">
    <div class="manage-check">
      ...
      <div class="back">
        <div class="default-btn" plain @click="back">{{$t('homes.goBack')}}</div>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    getData (orderNumber, refundSn) {
      this.$http({
        url: this.$http.adornUrl('/multishop/order_item/get_order_detail'),
        method: 'get',
    ...
    back () {
      this.$router.push('/shop-shopWalletLog')
    }
  }
}
</script>
