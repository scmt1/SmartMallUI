    ...
    <div class="limited-skill-container">
        ...
        <div class="limited-skill-pages">
            <goods-list-component 
              :config="goodsConfig" 
              :currentType="true"
              :type="'discount'"></goods-list-component>
        </div>
    </div>
</template>
<script>
...
export default {
  ...
  data () {
    return {
      titleConfig: { // 标题配置信息
        mainContent: {
          title: this.$i18n.t('pcdecorate.disCountForm.mainTitle'),
          fontSize: '24px',
        ...
        showSubTitle: 0,
        subContent: {
          title: this.$i18n.t('pcdecorate.disCountForm.subTitle'),
          fontSize: '12px',
    ...
    itemComponent: {
      handler (newVal, oldVal) {
        if (JSON.stringify(newVal.rightConfigMessage) != '{}') {
          ...
          this.titleConfig = {
            mainContent: {
              title: this.$t('pcdecorate.componentTitle.discountCoupon'),
              fontSize: '24px',
              color: 'rgba(51, 51, 51, 1)'
            },
            subContent: {
              title: this.$t('pcdecorate.disCountForm.subTitle'),
              fontSize: '12px',
              color: 'rgba(153, 153, 153, 1)'
            },
