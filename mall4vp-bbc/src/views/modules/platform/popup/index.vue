        ...
        <div class="main-container">
            ...
            <div class="table-con sys-user-table">
                <el-table ref="guideTable" :data="dataList" header-cell-class-name="table-header" row-class-name="table-row-low" style="width: 100%"
                    ...
                    <!-- 用户名 -->
                    <el-table-column prop="guidePic" label="弹窗缩略图" min-width="150">
                        <template slot-scope="scope">
                            <img :src="resourcesUrl + scope.row.guidePic" width="100px">
                        </template>
                    </el-table-column>
                    <!-- 用户昵称 -->
                    <el-table-column prop="guideTitle" label="弹窗标题" min-width="120">
                    </el-table-column>
                    <!-- 邮箱 -->
                    <el-table-column prop="guideUrl" label="弹窗链接" min-width="300">
                    </el-table-column>
                    <!-- 创建时间 -->
