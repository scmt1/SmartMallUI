          ...
          <div class="image-ad-edit">
            ...
            <div class="ad-edit-item">
              ...
              <div class="ad-edit-item-title ad-edit-img-height">
                ...
                <el-slider v-model="formData.imgHeight" style="width: 80%" @input="changeBoxHeight(true)" @change="changeBoxHeight(false)" :show-tooltip="showTooltip" show-input input-size="mini" :min="30" :max="5000"></el-slider>
              </div>
              <div class="ad-edit-item-title">
