        ...
        <div>
          <el-table :data="tableData5" style="width: 100%" height="180">
            <el-table-column
              ...
              width="160"
            ></el-table-column>
            <!-- <el-table-column prop :label="$t('dataAnalysis.xxxxxxx')累计会员数" width="120"></el-table-column>
            <el-table-column prop :label="$t('dataAnalysis.xxxxxxx')累计会员占比" width="120"></el-table-column>-->
            <el-table-column prop :label="$t('dataAnalysis.numberOfTradedMembers')" width="120"></el-table-column>
            <el-table-column prop :label="$t('dataAnalysis.tradedMembersRatio')" width="120"></el-table-column>
            <el-table-column prop :label="$t('dataAnalysis.payOrderQuantity')" width="120"></el-table-column>
            <el-table-column prop :label="$t('dataAnalysis.customerUnitPrice')" width="120"></el-table-column>
            <el-table-column prop :label="$t('dataAnalysis.paymentAmount')" width="120"></el-table-column>
            <el-table-column prop :label="$t('dataAnalysis.proportionOfPaymentAmount')" width="120"></el-table-column>
            <el-table-column prop :label="$t('dataAnalysis.perCapitaConsumptionFrequency')" width="120"></el-table-column>
          </el-table>
        </div>
      </div>
    </div>
