    ...
    <div class="config-items">
      ...
      <div class="bottom-content">
        <div class="goods-list-style">
          ...
          <div :class="{'style-items': true, 'active': goodsForm.listType === 4 }" @click="handleClick(4)">
            <img 
          ...
          <div :class="{'style-items': true, 'active': goodsForm.listType === 5 }" @click="handleClick(5)">
              <img 
          ...
          <el-radio-group 
            ...
            <el-radio 
              :label="3" 
              style="width: 33.3%;text-align: center">{{$t(`pcdecorate.goodsList.three`)}}</el-radio>
            <el-radio 
              :label="4" 
              style="width: 33.3%;text-align: center">{{$t(`pcdecorate.goodsList.four`)}}</el-radio>
            <el-radio 
              :label="5" 
              style="width: 33.3%;text-align: center">{{$t(`pcdecorate.goodsList.five`)}}</el-radio>
          </el-radio-group>
        </div>
    </div>
    <div class="config-items">
