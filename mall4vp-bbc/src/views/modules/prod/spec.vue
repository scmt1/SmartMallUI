        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <div class="ellipsis-text">{{ scope.row.propName }}</div>
            </template>
          </el-table-column>
          ...
          <el-table-column
            ...
            width="auto">
            <template slot-scope="scope">
              <div class="ellipsis-text">{{ scope.row.propNameEn }}</div>
            </template>
          </el-table-column>
          ...
          <el-table-column
            ...
            width="auto">
            <template slot-scope="scope">
              <div class="ellipsis-text">{{ scope.row.propValueList.join('/') }}</div>
            </template>
          </el-table-column>
          <el-table-column
            align="center"
            ...
            width="auto">
            <template slot-scope="scope">
              <div class="ellipsis-text">{{ scope.row.propValueEnList.join('/') }}</div>
            </template>
          </el-table-column>
      ...
      this.$http({
        ...
        for (let i = 0; i < data.records.length; i++) {
          ...
          for (let j = 0; j < item.prodPropValues.length; j++) {
            ...
            item.propValueEnList.push(element.propValue)
          }
        }
