        ...
        <div class="main-container">
            ...
            <div class="table-con sys-user-table">
                <el-table ref="guideTable" :data="dataList" header-cell-class-name="table-header" row-class-name="table-row-low" style="width: 100%"
                    ...
                    <el-table-column prop="guidePic" label="轮播图" min-width="150">
                        <template slot-scope="scope">
                            <img :src="resourcesUrl + scope.row.guidePic" width="150px">
                        </template>
                    </el-table-column>
                    <el-table-column prop="guideTitle" label="轮播标题" min-width="120">
                    </el-table-column>
                    <el-table-column prop="guideUrl" label="轮播链接" min-width="300">
                    </el-table-column>
