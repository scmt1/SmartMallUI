  ...
  data () {
    return {
      ...
      dataRule: {
        ...
        appKey: [
          { required: true, message: `${this.$i18n.t('sysManagement.expressBird')} appKey ${this.$i18n.t('sysManagement.nullTips')}`, trigger: 'blur' }
        ],
        reqUrl: [
          { required: true, message: `${this.$i18n.t('sysManagement.expressBird')} reqUrl ${this.$i18n.t('sysManagement.nullTips')}`, trigger: 'blur' }
        ]
      }
    }
  },
