<template>
  <div class="mod-index-img">
    ...
    >
      <el-form :model="dataForm" ref="dataForm" :rules="dataRule" label-width="180px">
        ...
        <el-form-item :label="this.$i18n.t('formData.reportInt')">
          <el-input
            type="textarea"
            :autosize="{ minRows: 2, maxRows: 4}"
            :placeholder="this.$i18n.t('formData.enterIntroduction')"
        ...
        <el-form-item :label="this.$i18n.t('formData.selectIndicator')" prop="formItem">
          <el-card class="box-card">
            <el-row style="width:100%">
              <el-col v-for="item in formItemList" :key="item.id" :span="4">
                <el-link
                  :underline="false"
                  class="buttonClick"
...
export default {
  ...
  methods: {
    ...
    // 表单提交
    dataFormSubmit () {
      this.dataForm.recommendForm = true
      this.dataForm.timeFormat = 2
